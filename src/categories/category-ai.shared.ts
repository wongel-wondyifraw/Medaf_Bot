...
export function buildCategoryPrompt(
  ...
  return [
    ...
    '- Nipple covers, pasties, sticky/adhesive/invisible bras, bra pads → Underwear,',
    '  even if the title mentions "wedding dress accessories" or "evening dress".',
    '- Skirts (midi, maxi, mermaid, pleated, holiday, etc.) → Dress, not Trousers.',
...
export function buildCategoryResolvePrompt(
  ...
  return [
    ...
    '- Nipple covers, pasties, sticky/adhesive/invisible bras, bra pads → Underwear,',
    '  even if the title mentions "wedding dress accessories" or "evening dress".',
    '- "Wedding dress accessories/supplies" are NOT Wedding Dress unless the item IS a gown.',
    '- Skirts (midi, maxi, mermaid, pleated, holiday, etc.) → Dress, not Trousers or NONE.',
    '- A shoe with any heel/stiletto/wedge/pump wording is a heel shoe, not a flat.',
